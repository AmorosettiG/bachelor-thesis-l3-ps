...
```
cd existing_repo
git remote add origin https://gitlab.com/AmorosettiG/bachelor-thesis-l3-ps.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/AmorosettiG/bachelor-thesis-l3-ps/-/settings/integrations)
